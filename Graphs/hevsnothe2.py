...
def main():
    ...
    while cap.isOpened():
        ...
        if frame1.shape[:2] == frame2.shape[:2]:
            ...
            frame1 = apply_histogram_equalization(frame1, roi1_x, roi1_y, roi1_width, roi1_height)
            # frame1 = apply_histogram_equalization(frame1, roi2_x, roi2_y, roi2_width, roi2_height)
            frame2 = apply_histogram_equalization(frame2, roi1_x, roi1_y, roi1_width, roi1_height)
            # frame2 = apply_histogram_equalization(frame2, roi2_x, roi2_y, roi2_width, roi2_height)
