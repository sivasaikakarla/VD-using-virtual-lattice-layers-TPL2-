...
excel_file_path = 'time_video1.xlsx'

# Function to append results to an Excel file
def append_to_excel(parallel_times, sequential_times):
    data = {'Frame': list(range(1, len(parallel_times) + 1)), 'Parallel': parallel_times, 'Sequential': sequential_times}
...
def main():
    ...
    append_to_excel(parallel_times, sequential_times)
