...
cap = cv2.VideoCapture('MVI_39271.mp4')

fourcc = cv2.VideoWriter_fourcc(*'mp4v')
out = cv2.VideoWriter('MVI_39271_output.mp4', fourcc, 20.0, (int(cap.get(3)), int(cap.get(4))))


if not os.path.exists('output_MVI_39271'):
    os.makedirs('output_MVI_39271')

ret, frame1 = cap.read()
ret, frame2 = cap.read()

excel_file_path = 'MVI_39271.xlsx'
...
def main():
    ...
    while cap.isOpened():
        ...
        if frame1.shape[:2] == frame2.shape[:2]:
            ...
            output_filename = f'output_MVI_39271/frame_{frame_count:04d}.jpg'
